...
us_pids <- read_csv(here::here('techno-economic', 
                               'data', 'us_PID_cords_PID1335.csv'))
...
dac <- st_read(here::here('techno-economic', 'data',
                          'DAC Shapefiles (v2022c)', 
...
```{r}
# Read Excel object
rci <- readxl::read_excel(here::here('techno-economic', 'data',
                                     'rural-capacity-index',
...
```{r}
# Read shapefile data frame
coal_mines <- st_read(here::here('techno-economic', 'data',
...
# Read shapefile data frame
coal_plants <- st_read(here::here('techno-economic', 'data',
                                  'ira_energy_communities_data',
                                  'retired_coal_plants',
...
```{r}
# Read raster object 
env_sens_tif <- stars::read_stars(here::here('techno-economic', 'data',
...
```{r}
wattmaps_dat <- read_csv(here::here('techno-economic', 'data',
                                    'wattmaps_dat_1288_final.csv'))
```
...
op_ratios <- read_csv(here::here('techno-economic', 'data',
                                 'optimal_ratios_project_info.csv'))

# Read data frame
substation_pids_df <- read_csv(here::here('techno-economic', 'data',
